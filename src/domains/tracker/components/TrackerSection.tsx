...
import TechCard from "@/domains/reports/components/TechCard";
import { TECH_TYPES } from "@/infrastructure/config/constants";
import ContentSectionCard from "@/domains/sections/components/ContentSectionCard";
